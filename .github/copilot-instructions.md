...
- `.github/agents/maf-dotnet-agent-instructions.md` - MAF agent development patterns and best practices
...
- Use `CosmosAgentThreadStore` for conversation persistence
